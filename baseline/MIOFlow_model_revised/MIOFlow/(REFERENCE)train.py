...
def train_ae(
    ...
    for epoch in range(n_epochs): # [Jiaqi]
        ...
        if recon:
            ...
            if epoch%50==0:
                ...
                print(f'Train loss recon: {np.round(np.mean(loss_recon.item()), 5)}') # [Jiaqi]
        ...
        if dist is not None:
            ...
            if epoch%50==0:
                ...
                print(f'Train loss dist: {np.round(np.mean(loss_dist.item()), 5)}') # [Jiaqi]
...
def training_regimen(
    ...
    for epoch in range(n_post_local_epochs):
        reverse = True if reverse_schema and epoch % reverse_n == 0 else False
