...
def integrate_backwards(
    args, end_samples, model, savedir, ntimes=100, memory=0.1, device="cpu" # [Jiaqi] Add args variable
):
...
def main(args):
    ...
    integrate_backwards(args, end_time_data, model, args.save, ntimes=100, device=device) # [Jiaqi] Add args variable
    exit()
    losses_list = []
