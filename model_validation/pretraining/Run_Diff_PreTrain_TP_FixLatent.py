'''
Description:
    Test scNODE when using different number of pre-training timepoints and fixing the latent space.
...
sys.path.append("../")
sys.path.append("../../")
# from benchmark.utils import loadSCData, tpSplitInd, tunedOurPars
        ...
        for strategy in strategy_list:
            ...
            try:
                ...
                latent_ode_model, loss_list, recon_obs, first_latent_dist, latent_seq, pretrained_model = scNODETrainWithDiffPreTrainTP(
                    ...
                    pretrain_iters=pretrain_iters, pretrain_lr=pretrain_lr, only_train_de=True,
                )
...
# Save results
# trial = 0
res_filename = "../../res/pretraining/res_fixed_latent/{}-{}-scNODE-diff_pretrain-res-trial{}.npy".format(data_name, split_type, trial)
state_filename = "../../res/pretraining/res_fixed_latent/{}-{}-scNODE-diff_pretrain-final_models-trial{}.pt".format(data_name, split_type, trial)
pretrain_state_filename = "../../res/pretraining/res_fixed_latent/{}-{}-scNODE-diff_pretrain-pretrain_models-trial{}.pt".format(data_name, split_type, trial)
